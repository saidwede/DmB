        ...
        <div class="lib-tool-bar-actions">
          ...
          <div class="profil-button drop-down-toggle">
            ...
            <div class="drop-down-menu">
              <RouterLink to="/app/abonement" class="drop-down-item text-orange"
                >Abonement</RouterLink
              >
              <RouterLink to="/app/profile" class="drop-down-item">Modifier le profile</RouterLink>
              <RouterLink to="/app/parametre-compte" class="drop-down-item"
                >Parametre du compte</RouterLink
              >
